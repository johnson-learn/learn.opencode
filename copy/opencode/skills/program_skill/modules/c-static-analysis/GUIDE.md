...
1. 先阅读 [references/usage.md](https://skillsmp.com/zh/creators/leokemp223/embed-ai-tool/references/usage.md)，确认本次使用哪个分析工具。
2. 若不确定工具是否可用，先运行 [scripts/static_analyzer.py](https://skillsmp.com/zh/creators/leokemp223/embed-ai-tool/scripts/static%5Fanalyzer.py) 的 `--detect` 模式。
...
7. 阅读 [references/misra-quick-ref.md](https://skillsmp.com/zh/creators/leokemp223/embed-ai-tool/references/misra-quick-ref.md) 了解常见 MISRA 违规。
