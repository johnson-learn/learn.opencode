...
open(os.path.join(repo_dir, "path_map.txt"), "w", encoding="utf-8").write(r"E:\openCodeDefault=E:\openCodeDefault")
...
# 本机有真实状态文件
open(os.path.join(local_dir, "path_map.txt"), "w", encoding="utf-8").write(r"E:\openCodeDefault=E:\\real")
...
check("本机 path_map.txt 保持真实映射", open(os.path.join(local_dir, "path_map.txt"), encoding="utf-8").read() == r"E:\openCodeDefault=E:\\real")
