...
| evolution 门禁（快照/改动检测/流水兜底追加/自动测试触发/待补充清单/--drain 自愈补跑/max_n 限流/配套漏更检测/五步检查点/判定四条件声明与可追溯/三条件依据软提示/经验健康引擎结构化扫描/新增与删除文件检测） | `test_evolution_gate.py` | `python tests\test_evolution_gate.py` | ✓ 37/37 |
