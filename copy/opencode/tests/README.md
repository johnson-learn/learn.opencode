...
| setup 安装核心逻辑模拟测试（mock curl/Start-Process/Stop-Process 实际执行分支流转+窗口管理） | `test_setup_sim.ps1` | `powershell -NoProfile -File tests\test_setup_sim.ps1 -FuncFile <仓库>\copy\setup\setup-install-functions.ps1` | ✓ 20/20 |
