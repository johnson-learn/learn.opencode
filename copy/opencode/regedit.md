...
| test_setup_sim.ps1 | `tests\test_setup_sim.ps1` | G | setup 安装核心逻辑**模拟测试**（用户 2026-08-28 要求真模拟：mock curl.exe/Start-Process/Stop-Process 实际执行动态版本解析与安装分支流转+窗口管理 20/20；被 test_setup_ps1 仓库直读模式调用） |
