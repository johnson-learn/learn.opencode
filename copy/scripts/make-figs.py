...
fig.tight_layout()
fig.savefig(r"C:\Users\<用户名>\AppData\Local\Temp\opencode\pucch-formats.svg", bbox_inches="tight")
plt.close(fig)
...
fig.tight_layout()
fig.savefig(r"C:\Users\<用户名>\AppData\Local\Temp\opencode\ra-zc.svg", bbox_inches="tight")
plt.close(fig)
...
fig.tight_layout()
fig.savefig(r"C:\Users\<用户名>\AppData\Local\Temp\opencode\ra-map.svg", bbox_inches="tight")
plt.close(fig)
