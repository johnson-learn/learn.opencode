...
f = r'C:\Users\<用户名>\Desktop\NR-f40\系统消息-01-SSB-MIB-SIB1与OSI.html'
...
svg2 = open(r'C:\Users\<用户名>\AppData\Local\Temp\opencode\fig2-new.svg', encoding='utf-8').read()
...
svg8 = open(r'C:\Users\<用户名>\AppData\Local\Temp\opencode\fig8-new.svg', encoding='utf-8').read()
...
figdir = r'C:\Users\<用户名>\AppData\Local\Temp\opencode\si-figs'
anchors = [
