...
$port = 9245
$tmp = "C:\Users\<用户名>\AppData\Local\Temp\opencode\chrome-pdcch"
...
$files = @(
  "file:///C:/Users/<用户名>/Desktop/NR-f40/PDCCH-02-CORESET资源结构.html",
  "file:///C:/Users/<用户名>/Desktop/NR-f40/PDCCH-04-盲检与哈希公式.html",
  "file:///C:/Users/<用户名>/Desktop/NR-f40/PDCCH-08-练习册与计算器.html"
)
foreach ($f in $files) {
