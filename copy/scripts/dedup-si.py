...
fig2 = open(r'C:\Users\<用户名>\AppData\Local\Temp\opencode\si-figs\fig2.html', encoding='utf-8').read()
i2 = B.find('<h3>2.2 原文表')
assert i2 > 0
B = B[:i2] + fig2 + '\n' + B[i2:]

fig4 = open(r'C:\Users\<用户名>\AppData\Local\Temp\opencode\si-figs\fig4.html', encoding='utf-8').read()
