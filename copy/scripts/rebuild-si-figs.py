...
restore = open(r'C:\Users\<用户名>\AppData\Local\Temp\opencode\si-restore.html', encoding='utf-8').read()
...
for key, anchor, pos in anchors:
    seg = open(rf'C:\Users\<用户名>\AppData\Local\Temp\opencode\si-figs\{key}.html', encoding='utf-8').read()
    i = html.find(anchor)
    if i < 0:
